...
3. Cloud Sync coordinates ciphertext only.
...
5. **What cloud does**: synchronize encrypted revisions and blobs; never store plaintext notes and never execute local tools.
