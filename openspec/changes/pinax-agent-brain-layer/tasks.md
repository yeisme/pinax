...
- [ ] **0.1 审计现有 Pinax brain building blocks**
  - Owner: `cli/pinax`
  - Lane: sequential
  - Depends on: none
...
- [ ] **0.2 固化 Agent Brain capability discovery 命名**
  - Owner: `cli/pinax`
  - Lane: A
  - Depends on: 0.1
...
- [ ] **0.3 定义 Agent Brain context bundle schema**
  - Owner: `cli/pinax`
  - Lane: A
  - Depends on: 0.1
...
- [ ] **1.1 设计 answer preview CLI/API 合同**
  - Owner: `cli/pinax`
  - Lane: B
  - Depends on: 0.3
...
- [ ] **1.3 Answer evidence contract tests**
  - Owner: `cli/pinax`
  - Lane: B
  - Depends on: 1.1
...
- [ ] **2.1 扩展 MCP tool 分组和只读 answer tools**
  - Owner: `cli/pinax`
  - Lane: C
  - Depends on: 1.1
...
- [ ] **2.2 HTTP MCP / OAuth / scopes / rate limit 作为 future-owner handoff**
...
- [ ] **2.3 Team/company KB permission model spec**
...
- [ ] **3.2 Maintenance/dream cycle plan-only implementation**
  - Owner: `cli/pinax`
  - Lane: D
  - Depends on: 1.3
...
- [ ] **3.3 Sync and rebuild policy for brain projections**
  - Owner: `cli/pinax`
  - Lane: D
  - Depends on: 3.1
