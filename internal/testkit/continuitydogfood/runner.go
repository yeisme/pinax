...
func writeEvidence(runDir string, cfg Config, summary Summary, cases []CaseResult) error {
	...
	files := map[string][]byte{
		...
		"command.txt":  []byte("go run ./internal/testkit/continuitydogfoodevidence --vault <isolated-real-vault>\n"),
		...
		filepath.Join("artifacts", "README.txt"):  []byte("Redacted task-level cohort evidence generated by internal/testkit/continuitydogfood.\n"),
	}
