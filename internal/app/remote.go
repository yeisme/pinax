...
func RemoteCapabilities() []domain.RemoteCapability {
	caps := []domain.RemoteCapability{
		...
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "kb.context", Surfaces: []string{"cli", "mcp"}, Command: "kb.context", Readonly: true, BodyAllowed: false, UIGroup: "provider.status", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax export markdown <output-dir> --vault <vault> --json", LocalOnlyReason: "deprecated-external-rag", RequestSchema: "pinax.kb.context.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"kb_decoupled"}},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "kb.review.overview", Surfaces: []string{"rest", "dashboard"}, Command: "kb.review.overview", Readonly: true, BodyAllowed: false, UIGroup: "provider.status", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax export markdown <output-dir> --vault <vault> --json", LocalOnlyReason: "deprecated-external-rag", RequestSchema: "pinax.kb.review.overview.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"kb_decoupled"}},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "kb.review.sources", Surfaces: []string{"rest", "dashboard"}, Command: "kb.review.sources", Readonly: true, BodyAllowed: false, UIGroup: "provider.status", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax export markdown <output-dir> --vault <vault> --json", LocalOnlyReason: "deprecated-external-rag", RequestSchema: "pinax.kb.review.sources.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"kb_decoupled"}},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "kb.review.evaluation_suites", Surfaces: []string{"rest", "dashboard"}, Command: "kb.review.evaluation_suites", Readonly: true, BodyAllowed: false, UIGroup: "provider.status", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax export markdown <output-dir> --vault <vault> --json", LocalOnlyReason: "deprecated-external-rag", RequestSchema: "pinax.kb.review.evaluation_suites.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"kb_decoupled"}},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "kb.review.evaluation_questions", Surfaces: []string{"rest", "dashboard"}, Command: "kb.review.evaluation_questions", Readonly: true, BodyAllowed: false, UIGroup: "provider.status", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax export markdown <output-dir> --vault <vault> --json", LocalOnlyReason: "deprecated-external-rag", RequestSchema: "pinax.kb.review.evaluation_questions.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"kb_decoupled"}},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "kb.review.run", Surfaces: []string{"rest", "dashboard"}, Command: "kb.review.run", Readonly: true, BodyAllowed: false, UIGroup: "provider.status", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax export markdown <output-dir> --vault <vault> --json", LocalOnlyReason: "deprecated-external-rag", RequestSchema: "pinax.kb.review.run.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"kb_decoupled"}},
...
func RemoteRoutes() []domain.RemoteRoute {
	...
	return []domain.RemoteRoute{
		...
		remoteRoute("rest.kb.review.overview", "rest", "GET", "/v1/kb/review/overview", "", byID["kb.review.overview"]),
		remoteRoute("rest.kb.review.sources", "rest", "GET", "/v1/kb/review/sources", "", byID["kb.review.sources"]),
		remoteRoute("rest.kb.review.evaluation_suites", "rest", "GET", "/v1/kb/review/evaluation-suites", "", byID["kb.review.evaluation_suites"]),
		remoteRoute("rest.kb.review.evaluation_questions", "rest", "GET", "/v1/kb/review/evaluation-suites/{suite_id}/questions", "", byID["kb.review.evaluation_questions"]),
		remoteRoute("rest.kb.review.run", "rest", "GET", "/v1/kb/review/runs/{run_id}", "", byID["kb.review.run"]),
