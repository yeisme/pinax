...
func RemoteCapabilities() []domain.RemoteCapability {
	caps := []domain.RemoteCapability{
		...
		// Agent runtime RPC surface: readonly experimental packs served through the
		// direct dispatcher; registered so /v1/rpc can reach them too.
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "agent.context", Surfaces: []string{"cli", "rpc"}, Command: "agent.context", Readonly: true, BodyAllowed: false, UIGroup: "agent.memory", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax agent context --vault <vault> --json", RequestSchema: "pinax.agent.context.request.v1", ResponseSchema: "pinax.projection.v1", Errors: []string{"index_unavailable"}},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "agent.memory.recall", Surfaces: []string{"cli", "rpc"}, Command: "agent.memory.recall", Readonly: true, BodyAllowed: false, UIGroup: "agent.memory", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax agent memory recall --vault <vault> --json", RequestSchema: "pinax.agent.memory.recall.request.v1", ResponseSchema: "pinax.projection.v1"},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "agent.continuity", Surfaces: []string{"cli", "rpc"}, Command: "agent.continuity", Readonly: true, BodyAllowed: false, UIGroup: "agent.continuity", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax continue --vault <vault>", RequestSchema: "pinax.agent.continuity.request.v1", ResponseSchema: "pinax.projection.v1"},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "agent.inbox", Surfaces: []string{"cli", "rpc"}, Command: "agent.inbox", Readonly: true, BodyAllowed: false, UIGroup: "agent.continuity", BodyExposureDefault: "none", WriteGate: "readonly", CopyCommand: "pinax review --vault <vault>", RequestSchema: "pinax.agent.inbox.request.v1", ResponseSchema: "pinax.projection.v1"},
		{SchemaVersion: domain.RemoteCapabilitySchemaVersion, ID: "agent.trust_center", Surfaces: []string{"rpc"}, Command: "agent.trust_center", Readonly: true, BodyAllowed: false, UIGroup: "agent.continuity", BodyExposureDefault: "none", WriteGate: "readonly", RequestSchema: "pinax.agent.trust_center.request.v1", ResponseSchema: "pinax.projection.v1"},
...
func webUIGroupForCommand(command, id string) string {
	...
	case strings.HasPrefix(id, "folder.") || strings.HasPrefix(id, "inbox.") || strings.HasPrefix(id, "draft.") || strings.HasPrefix(id, "note."):
		return "editor.note"
	case strings.Contains(command, "provider"):
...
func RemoteRoutes() []domain.RemoteRoute {
	...
	return []domain.RemoteRoute{
		...
		remoteRoute("rpc.agent.continuity", "rpc", "CALL", "", "Pinax.Agent.Continuity", byID["agent.continuity"]),
		remoteRoute("rpc.agent.inbox", "rpc", "CALL", "", "Pinax.Agent.Inbox", byID["agent.inbox"]),
		remoteRoute("rpc.agent.trust_center", "rpc", "CALL", "", "Pinax.Agent.TrustCenter", byID["agent.trust_center"]),
