...
| 能力 | 状态 |
| --- | --- |
| 本地 Markdown vault、note、journal、inbox/draft、template、search、query/dataview、link/backlink、asset、project board、repair/organize plan | 已支持 |
...
从 GitHub Release 下载预编译 archive（当前稳定 tag：`v0.1.0`）：
